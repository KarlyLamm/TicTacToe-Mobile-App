...
with_node \
  ...
  --target "/Users/karlylamm/Desktop/unbeatable-tic-tac-toe/ios/Pods/Target Support Files/Pods-unbeatabletictactoe/ExpoModulesProvider.swift" \
  --entitlement "/Users/karlylamm/Desktop/unbeatable-tic-tac-toe/ios/unbeatabletictactoe/unbeatabletictactoe.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-asset" "expo-blur" "expo-constants" "expo-file-system" "expo-font" "expo-haptics" "expo-image" "expo-keep-awake" "expo-linear-gradient" "expo-linking" "expo-router" "expo-sharing" "expo-splash-screen" "expo-symbols" "expo-system-ui" "expo-web-browser"
